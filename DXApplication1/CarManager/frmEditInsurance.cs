...
namespace CarManager
{
    public partial class frmEditInsurance : Form
    {
        ...
        private void frmEditInsurance_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (valid)
            {
                ...
                bool result = db.UpdateInsurance(tmp);
                if (result)
                {
